...
//        timeTF.text = timeString
        ...
        reminderTF.text = meetingDetail!.reminderinString!
//        reminderTF.text = "\(Int(minutes)) Minutes"
    ...
    // Add Gesture in MapView
    func addGestureToMap(){
        let gesture = UITapGestureRecognizer(target: self, action: #selector(mapLongPressed))
        self.mapView.isUserInteractionEnabled = true
        self.mapView.addGestureRecognizer(gesture)
    }
    
    @objc func mapLongPressed(){
        print("Map Long Pressed ")
    }
